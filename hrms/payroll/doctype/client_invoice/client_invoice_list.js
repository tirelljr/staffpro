	...
	const dialog = new frappe.ui.Dialog({
		...
		fields: [
			...
			},
			{
				...
				description: __("Working days (Mon–Fri) in a weekly billing period. Set 0 to skip this template."),
			},
			{
				...
				description: __("Working days (Mon–Fri) in a 2-week billing period. Set 0 to skip this template."),
			},
			{
				...
				description: __("Working days (Mon–Fri) in a monthly billing period. Set 0 to skip this template."),
			},
		],
