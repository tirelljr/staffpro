	...
	const dialog = new frappe.ui.Dialog({
		...
		fields: [
			...
			},
			{
				...
				description: __("Days in a weekly pay period. Set 0 to skip this template."),
			},
			{
				...
				description: __("Days in a 2-week pay period. Set 0 to skip this template."),
			},
			{
				...
				description: __("Days in a monthly pay period. Set 0 to skip this template."),
			},
		],
